...
- [x] **Phase 5: Recovery, Observability & Ops Polish** - Auth-gated /health/details, automatic log rotation, completed test suite passing with Win/Mac parity (completed 2026-09-05)
...
- [x] 03-03-PLAN.md — GUI one-key refresh joins the same lock file, warning-when-held, finally-release (D-01)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 03-04-PLAN.md — Real-machine live gate: restart, SC1-SC5 smoke, SC5 kill/restart → interrupted, D-02 verify-only
...
- [x] 04-03-PLAN.md — /v1/private/* token-gated raw read endpoints (portfolio/journal/candidates, freshness headers) + SC2 route-by-route classification audit
- [x] 04-04-PLAN.md — Date parameter whitelist (YYYY-MM-DD/YYYYMMDD): single-token arg-list append, date_args.py single-source validator, script-side session-date gates
...
- [x] 05-03-PLAN.md — README known-limits + Mac checklist (D-37/D-35) + PROJECT.md /health/details classification row + D-36 15:30 task audit record
...
| 5. Recovery, Observability & Ops Polish | 4/4 | Complete    | 2026-09-05 |
